...
avi-ascii.svg — sorry, sabba-ascii.svg.
...
OUT = os.environ.get("OUT", "sabba-ascii.svg")
...
def build(lines, rows):
    ...
    for r, raw in enumerate(lines):
        ...
        if not STATIC:
            ...
            body.append(
                ...
                f'height="{CH * 0.86:.1f}" fill="{k.ACCENT}" opacity="0">'
    ...
    return k.panel(w, h, "sabba@github: ~/whoami",
                   "\n".join(body), defs="\n".join(defs))
